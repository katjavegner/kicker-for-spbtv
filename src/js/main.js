...
import TeamPopup from './components/popups/team-popup';
  ...
  <Provider store={ store }>
    <Router history={ browserHistory }>
      <Route path='/' component={ PageContent }>
        ...
        <Route path='teams/edit/:id' header='Команды' components={{
          content: TeamsContainer,
          sidebar: SidebarTeams,
          popup: TeamPopup
        }}/>
        <Route path='teams/create' header='Команды' components={{
          content: TeamsContainer,
          sidebar: SidebarTeams,
          popup: TeamPopup
        }}/>
